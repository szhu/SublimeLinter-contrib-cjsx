...
1. When the plugin list appears, type `cjsx`. Among the entries you should see `SublimeLinter-coffee`. If that entry is not highlighted, use the keyboard or mouse to select it.
